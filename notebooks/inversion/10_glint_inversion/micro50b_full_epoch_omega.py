...
micro50 showed that scoring at 2-6 glint epochs is too degenerate.  But the
...
# ===========================================================================
print("=" * 70)
print("micro50b -- Full-epoch alignment scoring for omega direction")
print("=" * 70)
t_global = time.time()
...
plt.tight_layout()
plot_path = RESULTS_DIR / "micro50b_full_epoch_omega.png"
...
results = {
    'experiment': 'micro50b_full_epoch_omega',
    'n_dirs': N_DIRS,
    'n_mags': N_MAGS,
...
json_path = RESULTS_DIR / "micro50b_full_epoch_omega.json"
