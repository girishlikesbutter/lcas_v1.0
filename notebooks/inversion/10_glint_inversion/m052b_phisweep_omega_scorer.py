...
Use peak-count |omega| estimate from m052 Part A.  Search only direction
...
# ===========================================================================
print("=" * 70)
print("m052b -- Phi-sweep as omega direction scorer")
print("=" * 70)
t_global = time.time()
...
# Peak count calibration from m052
...
plt.tight_layout()
plot_path = RESULTS_DIR / "m052b_phisweep_omega_scorer.png"
fig.savefig(str(plot_path), dpi=150, bbox_inches='tight')
plt.close(fig)
print(f"Plot: {plot_path}")

json_path = RESULTS_DIR / "m052b_phisweep_omega_scorer.json"
with open(str(json_path), 'w') as f:
    json.dump({'experiment': 'm052b_phisweep_omega_scorer',
