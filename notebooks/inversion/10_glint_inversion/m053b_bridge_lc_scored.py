...
m053 showed the bridge GENERATES close omega candidates (traj 70: 6 deg)
...
# ===========================================================================
print("=" * 70)
print("m053b -- Bridge omega + LC residual scoring (NO ORACLE)")
print("=" * 70)
t_global = time.time()
...
plt.tight_layout()
fig.savefig(str(RESULTS_DIR / "m053b_bridge_lc.png"), dpi=150)
plt.close(fig)

with open(str(RESULTS_DIR / "m053b_bridge_lc.json"), 'w') as f:
    json.dump({'experiment': 'm053b', 'results': all_results,
