...
Part A: Does micro42b's phi-sweep architecture generalise to the micro46 dataset
...
Part B: Anchor census across all 100 micro46 trajectories.
...
# ===========================================================================
print("=" * 70)
print("micro49 -- Generalization test + anchor census")
print("=" * 70)
t_global = time.time()
...
def run_phi_sweep_for_trajectory(traj_idx):
    """Run micro42b-style phi sweep for one trajectory.
...
plt.tight_layout()
plot_path = RESULTS_DIR / "micro49_generalization_and_census.png"
...
results = {
    'experiment': 'micro49_generalization_and_census',
    'part_a': {
...
json_path = RESULTS_DIR / "micro49_generalization_and_census.json"
