...
# ===========================================================================
print("=" * 70)
print("micro50d -- Differential Evolution for omega recovery")
print("=" * 70)
t_global = time.time()
...
plt.tight_layout()
plot_path = RESULTS_DIR / "micro50d_omega_de.png"
...
# ===========================================================================
results_json = {
    'experiment': 'micro50d_omega_de',
    'n_test': len(TEST_TRAJS),
    'results': all_results,
    'total_time_s': time.time() - t_global,
}

json_path = RESULTS_DIR / "micro50d_omega_de.json"
