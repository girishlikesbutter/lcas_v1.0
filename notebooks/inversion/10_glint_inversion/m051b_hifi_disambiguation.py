...
# ===========================================================================
print("=" * 70)
print("m051b -- Hi-fi disambiguation (oracle omega, 10 trajectories)")
print("=" * 70)
t_global = time.time()
...
# Save
plot_path = RESULTS_DIR / "m051b_hifi_disambiguation.png"
...
json_path = RESULTS_DIR / "m051b_hifi_disambiguation.json"
with open(str(json_path), 'w') as f:
    json.dump({'experiment': 'm051b_hifi_disambiguation',
               'results': all_results,
