...
# ===========================================================================
print("=" * 70)
print("micro52c -- Full LC residual as omega direction scorer")
print("=" * 70)
t_global = time.time()
...
plt.tight_layout()
fig.savefig(str(RESULTS_DIR / "micro52c_lc_omega_scorer.png"), dpi=150)
plt.close(fig)

with open(str(RESULTS_DIR / "micro52c_lc_omega_scorer.json"), 'w') as f:
    json.dump({'experiment': 'micro52c', 'results': all_results,
