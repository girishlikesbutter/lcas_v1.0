...
# ===========================================================================
print("=" * 70)
print("micro52 -- Spectral omega estimation")
print("=" * 70)
t_global = time.time()
...
plt.tight_layout()
plot_path = RESULTS_DIR / "micro52_spectral_omega.png"
...
# Save
results = {
    'experiment': 'micro52_spectral_omega',
    'part_a': {
...
json_path = RESULTS_DIR / "micro52_spectral_omega.json"
