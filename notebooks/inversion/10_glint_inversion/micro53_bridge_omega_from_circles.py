...
N_PHI = 36
PEAK_COEFFS = np.array([0.0417, 0.0397])  # from micro52
...
# ===========================================================================
print("=" * 70)
print("micro53 -- Bridge omega from two glint circles")
print("=" * 70)
t_global = time.time()
...
plt.tight_layout()
fig.savefig(str(RESULTS_DIR / "micro53_bridge_omega.png"), dpi=150)
plt.close(fig)

with open(str(RESULTS_DIR / "micro53_bridge_omega.json"), 'w') as f:
    json.dump({'experiment': 'micro53', 'results': all_results,
