...
Architecture (building on m042b):
...
# ===========================================================================
print("=" * 70)
print("m051 -- End-to-end glint-anchored inversion pipeline")
print("=" * 70)
t_global = time.time()
...
assert np.allclose(observation_times, CTX.observation_times, atol=0.1), \
    "m046 and CTX observation times don't match!"
...
plt.tight_layout()
plot_path = RESULTS_DIR / "m051_end_to_end.png"
...
json_path = RESULTS_DIR / "m051_end_to_end.json"
