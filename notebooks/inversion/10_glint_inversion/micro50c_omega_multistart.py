...
micro50b showed the full-epoch alignment score has a clear global minimum at truth
...
# ===========================================================================
print("=" * 70)
print("micro50c -- Multi-start Nelder-Mead omega recovery")
print("=" * 70)
t_global = time.time()
...
plt.tight_layout()
plot_path = RESULTS_DIR / "micro50c_omega_multistart.png"
...
# ===========================================================================
results_json = {
    'experiment': 'micro50c_omega_multistart',
    'n_starts': N_STARTS,
    'results': all_results,
    'total_time_s': time.time() - t_global,
}

json_path = RESULTS_DIR / "micro50c_omega_multistart.json"
