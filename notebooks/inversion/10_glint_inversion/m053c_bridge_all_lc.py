...
print("=" * 70)
print("m053c -- ALL bridges scored by LC residual (NO ORACLE)")
print("=" * 70)
t_global = time.time()
...
with open(str(RESULTS_DIR / "m053c_bridge_all_lc.json"), 'w') as f:
    json.dump({'experiment': 'm053c', 'results': all_results,
