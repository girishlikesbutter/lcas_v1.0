...
# ===========================================================================
print("=" * 70)
print("m050 -- Omega landscape and initialization")
print("=" * 70)
t_global = time.time()
...
TRAJ_A = 84  # from m049: correct hyp won, 1.29 deg att_err, 7 glints
...
plt.tight_layout()
plot_path = RESULTS_DIR / "m050_omega_landscape.png"
...
results = {
    'experiment': 'm050_omega_landscape',
    'part_a': {
        'trajectory': TRAJ_A,
...
np.savez_compressed(
    str(RESULTS_DIR / "m050_omega_landscape.npz"),
    mag_range=mag_range,
...
json_path = RESULTS_DIR / "m050_omega_landscape.json"
