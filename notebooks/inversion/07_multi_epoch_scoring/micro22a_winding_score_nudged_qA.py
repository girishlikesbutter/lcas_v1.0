...
Uses micro17's original 8 omega solutions (found from true endpoints) and just
...
Given micro21's finding that even oracle q_A gives rank=3/8, this script
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    out_png = RESULTS_DIR / "micro22a_winding_nudge.png"
    plt.savefig(out_png, dpi=150, bbox_inches='tight')
    plt.close()
    print(f"\nSaved: {out_png}")

    # ── JSON ──────────────────────────────────────────────────────────────
    out_json = RESULTS_DIR / "micro22a_winding_nudge.json"
