...
![LC overlay](../../../data/results/inversion_diagnostics/micro21_multi_epoch_winding_score.png)
...
The staircase (micro17) finds 8 ω solutions that bridge q_A → q_B with arrival error ≈ 0. Each differs by roughly one full revolution. However:
