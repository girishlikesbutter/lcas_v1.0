"""m027 — Single-bridge screening for candidate pair pruning.
...
if __name__ == '__main__':
    ...
    m013 = np.load('data/results/inversion_diagnostics/m013_stage1.npz')
    peaks = m013['peaks']            # [183, 260, 360]
    truth_idx = m013['truth_idx']    # [49, 49, 49]
    ...
    # ── Part B: m013 real iso-brightness candidates ──────────────────
    print("Part B: m013 iso-brightness candidates...")
    c_m = [m013['c0'], m013['c1'], m013['c2']]
    ti = truth_idx
    ...
    fig.suptitle('m027: Single-bridge screening for pair pruning', fontsize=14)

    panels = [
        (axes[0, 0], omA0, tA0_om, rA0_om, 'Part A leg 0 (oracle +/- 1-3 deg)'),
        (axes[0, 1], omB0, tB0_om, rB0_om, 'Part B leg 0 (m013 candidates)'),
        (axes[1, 0], resA0, tA0_res, rA0_res, 'Part A leg 0 — arrival residual'),
        (axes[1, 1], omB1, tB1_om, rB1_om, 'Part B leg 1 (m013 candidates)'),
    ]
    ...
    plt.tight_layout()
    out_plot = 'data/results/inversion_diagnostics/m027_bridge_screening.png'
    ...
    save_results('data/results/inversion_diagnostics/m027_bridge_screening.json', {
    ...
    print(f"Part B (m013 candidates):")
