...
Clean rerun of micro26b. Two omegas are duplicates only if BOTH |omega| within
0.05 deg/s AND angular distance between unit vectors < 5 deg.

Changes from micro26b:
  - Renamed to micro26c throughout
...
if __name__ == '__main__':
    ...
    # Load peak indices from micro13 stage 1
    ...
    print(f"  cf. micro26: 34/32 candidates, rank 423/1088, gap 1.80e+00")
    print(f"{'='*60}")
    ...
    plt.tight_layout()
    out_png = RESULTS_DIR / "micro26c_oracle_direction_dedup.png"
    ...
    out_json = RESULTS_DIR / "micro26c_oracle_direction_dedup.json"
