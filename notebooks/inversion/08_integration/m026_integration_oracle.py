...
Wires m020 (band-sweep bridge solves) + m023 (L-conservation scoring)
...
if __name__ == '__main__':
    ...
    out_png = RESULTS_DIR / "m026_integration_oracle.png"
    plt.savefig(out_png, dpi=150, bbox_inches='tight'); plt.close(); print(f"Saved: {out_png}")
    save_results(RESULTS_DIR / "m026_integration_oracle.json", {
    ...
    print(f"Saved: {RESULTS_DIR / 'm026_integration_oracle.json'}")
