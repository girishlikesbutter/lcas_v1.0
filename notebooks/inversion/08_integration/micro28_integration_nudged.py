...
if __name__ == '__main__':
    ...
    # Save
    save_results(RESULTS_DIR / "micro28_integration_nudged.json", {
        'trials': all_results,
    ...
    plt.tight_layout()
    out_png = RESULTS_DIR / "micro28_integration_nudged.png"
    plt.savefig(out_png, dpi=150, bbox_inches='tight')
    plt.close()
    print(f"Saved: {out_png}")
    print(f"Saved: {RESULTS_DIR / 'micro28_integration_nudged.json'}")
