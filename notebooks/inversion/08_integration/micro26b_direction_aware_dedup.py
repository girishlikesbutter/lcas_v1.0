#!/usr/bin/env python3
"""Micro-26b — Same pipeline as micro26 but with direction-aware deduplication.
...
if __name__ == '__main__':
    ...
    out_png = RESULTS_DIR / "micro26b_direction_aware_dedup.png"
    plt.savefig(out_png, dpi=150, bbox_inches='tight'); plt.close(); print(f"Saved: {out_png}")
    save_results(RESULTS_DIR / "micro26b_direction_aware_dedup.json", {
    ...
    print(f"Saved: {RESULTS_DIR / 'micro26b_direction_aware_dedup.json'}")
