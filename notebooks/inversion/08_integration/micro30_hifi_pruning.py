...
# ---------------------------------------------------------------------------
print("=" * 60)
print("micro30 — Hi-fi pruning of lo-fi iso-brightness candidates")
print("=" * 60)
...
out_json = RESULTS_DIR / "micro30_hifi_pruning.json"
...
out_png = RESULTS_DIR / "micro30_hifi_pruning.png"
