"""
micro01c: Peak omega recovery with quaternion nudge errors (lo-fi reconstructions).

Identical to micro01b except the reconstructed LCs (step 6) are generated
...
for ti, (q0, label) in enumerate(zip(Q0S, LABELS)):
    ...
    for nudge_deg in NUDGE_DEGS:
        ...
        fig.savefig(OUT / f"micro01c_lofi_qnudge_{om_tag}_traj{ti}_nudge{nudge_deg}.png",
