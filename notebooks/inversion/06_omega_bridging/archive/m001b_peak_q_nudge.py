"""
m001b: Peak omega recovery with quaternion nudge errors.

Same as m001 but simplified: only use (k-1, k) pair, only propagate
...
for ti, (q0, label) in enumerate(zip(Q0S, LABELS)):
    ...
    for nudge_deg in NUDGE_DEGS:
        ...
        fig.savefig(OUT / f"m001b_qnudge_{om_tag}_traj{ti}_nudge{nudge_deg}.png",
