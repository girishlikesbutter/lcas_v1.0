...
path better than intermediate-epoch scoring (used in micro13/14)?
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    fig_path = RESULTS_DIR / "micro16_dip_constraint.png"
    ...
    json_path = RESULTS_DIR / "micro16_dip_constraint.json"
    ...
    print(f"""
=== micro16: dip constraint experiment ===
