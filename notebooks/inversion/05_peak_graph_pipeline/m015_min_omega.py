...
axis-angle estimate (m013 method)?  Does the true pair stand out?
"""
...
def bridge_axis_angle(q_start, q_end, dt, I):
    """Bridge ω via axis-angle initial guess (current m013 method)."""
...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.savefig(RESULTS_DIR / "m015_min_omega.png", dpi=150)
    plt.close()
    ...
    print("=== m015: minimum-magnitude ω experiment ===")
    ...
    save_results(RESULTS_DIR / "m015_min_omega.json", results_out)
