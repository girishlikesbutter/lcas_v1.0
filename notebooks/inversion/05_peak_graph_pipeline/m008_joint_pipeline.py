...
Loads peak-1 candidates from m007_stage1.npz checkpoint.
...
if __name__ == '__main__':
    ...
    # Load checkpoint
    ckpt = np.load(RESULTS_DIR / 'm007_stage1.npz')
    ...
    # ── Save checkpoints ──
    np.savez(RESULTS_DIR / 'm008_joint.npz',
    ...
    save_results(RESULTS_DIR / 'm008_joint.json', {
    ...
    print(f"\nSaved to {RESULTS_DIR}/m008_joint.*")
