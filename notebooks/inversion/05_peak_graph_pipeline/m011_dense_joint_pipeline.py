...
if __name__ == '__main__':
    ...
    ckpt = np.load(RESULTS_DIR / 'm010b_dense_candidates.npz')
    ...
    # ── Save checkpoint ──
    np.savez(RESULTS_DIR / 'm011_dense_joint.npz',
    ...
    save_results(RESULTS_DIR / 'm011_dense_joint.json', {
