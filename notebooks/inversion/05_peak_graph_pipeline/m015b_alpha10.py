...
m015 tested alpha=0.1, where ||ω||² ≈ 0.0013 for the true omega contributes
...
ALPHA = 10.0  # 100x larger than m015's 0.1
...
if __name__ == "__main__":
    ...
    fig.suptitle(f'm015b: min-|ω| with α={ALPHA}', fontsize=12)
    ...
    plt.tight_layout()
    plt.savefig(RESULTS_DIR / "m015b_alpha10.png", dpi=150)
    plt.close()
    ...
    save_results(RESULTS_DIR / "m015b_alpha10.json", results_out)
