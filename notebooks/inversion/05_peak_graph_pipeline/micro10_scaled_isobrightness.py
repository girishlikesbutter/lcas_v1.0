...
Save checkpoint compatible with micro-08 pipeline (micro07_stage1.npz format).
"""
...
if __name__ == '__main__':
    ...
    # ── Save checkpoint (micro07_stage1.npz compatible) ──
    obs_mag_p2 = CTX.observed_lc[PEAK2]
    ckpt_path = RESULTS_DIR / 'micro10_optimized_candidates.npz'
    ...
    save_results(RESULTS_DIR / 'micro10_scaled_isobrightness.json', {
        ...
        'comparison': {'random_1M_nearest_deg': 5.95,
                       'micro09_100seeds_nearest_deg': 25.64, 'micro09_basins': 71,
                       'micro10_nearest_deg': float(ang_dists[i_near]),
                       'micro10_basins': n_unique},
