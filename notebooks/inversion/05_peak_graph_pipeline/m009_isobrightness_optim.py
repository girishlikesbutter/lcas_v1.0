...
if __name__ == '__main__':
    ...
    # ── Save checkpoint ──
    np.savez(RESULTS_DIR / 'm009_isobrightness_optim.npz',
    ...
    save_results(RESULTS_DIR / 'm009_isobrightness_optim.json', {
        ...
        'comparison': {'m007_random_1M_nearest_deg': 5.95,
                       'm009_optim_nearest_deg': float(nearest['att_error_deg'])},
        'runtime_s': round(time.time() - t0, 1)})

    print(f"\nSaved to {RESULTS_DIR}/m009_isobrightness_optim.*")
