"""micro15b_alpha_sweep.py — sweep alpha for min-|ω| bridge objective on leg 0."""
...
# ── Load stage data ────────────────────────────────────────────────────────────
stage1 = np.load(RESULTS_DIR / "micro13_stage1.npz", allow_pickle=True)
stage2 = np.load(RESULTS_DIR / "micro13_stage2.npz", allow_pickle=True)
...
plt.tight_layout()
out_png = RESULTS_DIR / "micro15b_alpha_sweep.png"
plt.savefig(out_png, dpi=150)
print(f"\nPlot saved: {out_png}")

# ── Save JSON ──────────────────────────────────────────────────────────────────
save_results(RESULTS_DIR / "micro15b_alpha_sweep.json", {
    'alphas': ALPHAS,
    'true_pair': {
        'i': ti0, 'j': ti1,
...
print(f"JSON saved: {RESULTS_DIR / 'micro15b_alpha_sweep.json'}")
