...
Uses m017's 8 staircase omega solutions for leg 0 (peaks 183->260, ~554s).
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    out_png = RESULTS_DIR / "m021_multi_epoch_winding_score.png"
    ...
    out_json = RESULTS_DIR / "m021_multi_epoch_winding_score.json"
