...
For both legs (using oracle attitudes at 3 peaks from m013_stage1.npz):
...
- Diagnoses the leg-1 staircase gap (m018): does a solution near 2.08 deg/s exist?
"""
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    out_png = RESULTS_DIR / "m019_winding_landscape.png"
    ...
    save_results(RESULTS_DIR / "m019_winding_landscape.json", json_data)
    print(f"Saved: {RESULTS_DIR / 'm019_winding_landscape.json'}")
