...
if __name__ == '__main__':
    ...
    PEAKS_3 = [int(x) for x in np.load(RESULTS_DIR / "m013_stage1.npz")["peaks"]]
    ...
    plt.tight_layout()
    out_png = RESULTS_DIR / "m025_L_three_leg.png"
    plt.savefig(out_png, dpi=150, bbox_inches='tight'); plt.close()
    print(f"Saved: {out_png}")

    save_results(RESULTS_DIR / "m025_L_three_leg.json", {
