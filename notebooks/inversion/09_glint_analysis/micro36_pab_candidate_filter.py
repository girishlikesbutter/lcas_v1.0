...
Background:
  micro34 showed that at brightness peaks, a single facet normal aligns with the
  Phase Angle Bisector (PAB) with n.PAB > 0.993. Intelsat 901 has 14 unique
  facet-normal directions. micro10 produced 5643 iso-brightness attitude
...
# ===========================================================================
print("=" * 70)
print("micro36 -- PAB alignment as attitude candidate filter")
print("=" * 70)
...
# ===========================================================================
# Load micro10 candidate attitudes at epoch 183
# ===========================================================================
print("\n--- Loading micro10 candidates ---")

micro10_path = RESULTS_DIR / "micro10_optimized_candidates.npz"
micro10_data = np.load(str(micro10_path))
candidate_q_wxyz = micro10_data['candidate_q_wxyz']  # (5643, 4) in wxyz
ang_dists_to_truth_q0 = micro10_data['ang_dists_to_truth']
n_candidates = len(candidate_q_wxyz)
print(f"Loaded {n_candidates} candidates from {micro10_path.name}")
print(f"  peak1_idx = {int(micro10_data['peak1_idx'])}")
...
plot_path = RESULTS_DIR / "micro36_pab_candidate_filter.png"
...
results = {
    'experiment': 'micro36_pab_candidate_filter',
...
json_path = RESULTS_DIR / "micro36_pab_candidate_filter.json"
