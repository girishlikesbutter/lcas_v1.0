...
RESULTS_JSON = RESULTS_DIR / "micro37_brdf_glint_profile.json"
RESULTS_PNG  = RESULTS_DIR / "micro37_brdf_glint_profile.png"
...
def main():
    t0 = time.time()
    results = {"experiment": "micro37", "description": "BRDF specular glint profile characterization"}
