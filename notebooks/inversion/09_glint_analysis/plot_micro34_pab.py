#!/usr/bin/env python3
"""Standalone plot for micro34 PAB alignment diagnostic.

Loads pre-computed arrays from NPZ + group metadata from JSON.
Run micro34_pab_alignment.py first to generate the data files.
"""
...
# Load data
# ---------------------------------------------------------------------------
npz = np.load(str(RESULTS_DIR / "micro34_pab_alignment.npz"))
true_lc = npz['true_lc']
...
with open(str(RESULTS_DIR / "micro34_pab_alignment.json")) as f:
    meta = json.load(f)
