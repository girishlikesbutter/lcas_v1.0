...
Question: Does the single-facet specular glint finding from m034 hold
...
# ===========================================================================
print("=" * 70)
print("m035 -- Multi-trajectory PAB alignment robustness study")
print("=" * 70)
...
all_results = []
json_path = RESULTS_DIR / "m035_multi_trajectory_pab.json"
...
for traj_idx in range(N_TRAJECTORIES):
    ...
    partial_output = {
        'experiment': 'm035_multi_trajectory_pab',
...
plot_path = RESULTS_DIR / "m035_multi_trajectory_pab.png"
