...
RESULTS_DIR = PROJECT_ROOT / "data" / "results" / "inversion_diagnostics" / "m046_trajectories"
...
# ===========================================================================
print("=" * 70)
print(f"m046 -- Generate {N_TRAJECTORIES} realistic trajectories")
...
# Save
npz_path = RESULTS_DIR / "m046_trajectories.npz"
...
print(f"\n{'=' * 70}")
print(f"m046 complete: {N_TRAJECTORIES} trajectories in {elapsed:.0f}s ({elapsed/60:.1f}min)")
