...
RESULTS_DIR = PROJECT_ROOT / "data" / "results" / "inversion_diagnostics" / "micro47_glint_stats"
RESULTS_DIR.mkdir(parents=True, exist_ok=True)

DATA_PATH = PROJECT_ROOT / "data" / "results" / "inversion_diagnostics" / "micro46_trajectories" / "micro46_trajectories.npz"

# ===========================================================================
# Load data
# ===========================================================================
print("=" * 70)
print("micro47 -- Glint classification statistics (100 trajectories)")
print("=" * 70)
t0 = time.time()

print("Loading micro46 data...")
...
plot_path = RESULTS_DIR / "micro47_glint_statistics.png"
