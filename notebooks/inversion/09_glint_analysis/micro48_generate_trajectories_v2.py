...
RESULTS_DIR = PROJECT_ROOT / "data" / "results" / "inversion_diagnostics" / "micro48_trajectories"
...
# ===========================================================================
print("=" * 70, flush=True)
print(f"micro48 -- Generate {N_TRAJECTORIES} trajectories (randomised start times)", flush=True)
...
npz_path = RESULTS_DIR / "micro48_trajectories.npz"
...
print(f"\n{'=' * 70}", flush=True)
print(f"micro48 complete: {N_TRAJECTORIES} trajectories in {elapsed:.0f}s ({elapsed/60:.1f}min)", flush=True)
