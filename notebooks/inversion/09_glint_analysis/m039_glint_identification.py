...
Method:
  ...
  4. Compare blind clusters to oracle labels (dominant normal group from m034)
...
LOG_PATH = RESULTS_DIR / "m039_stdout.txt"
...
# ===========================================================================
print("=" * 70)
print("m039 -- Blind glint component identification from LC shape")
print("=" * 70)
...
# ===========================================================================
# Load m034 data for oracle labels
# ===========================================================================
print("\n--- Loading m034 oracle data ---")

m034_npz = np.load(str(RESULTS_DIR / "m034_pab_alignment.npz"))
true_lc = m034_npz['true_lc']            # (500,) hi-fi noiseless LC
frac_flux = m034_npz['frac_flux']         # (14, 500) fractional flux per group per epoch
unique_normals = m034_npz['unique_normals']  # (14, 3)

with open(RESULTS_DIR / "m034_pab_alignment.json") as f:
    m034_json = json.load(f)
group_info = m034_json['all_groups']  # list of dicts with 'group_id', 'components', 'total_area', etc.
...
print(f"  Max |m034_true_lc - CTX.true_lc| = {lc_diff:.6f}")
if lc_diff > 0.01:
...
# ===========================================================================
print("\n--- Oracle labels (from m034 fractional flux) ---")
...
ax2.set_title("Panel 2: Oracle grouping (m034 dominant normal group)")
ax2.legend(fontsize=7, loc='upper right')
ax2.grid(True, alpha=0.3)

plt.tight_layout()

plot_path = RESULTS_DIR / "m039_glint_identification.png"
...
results = {
    'experiment': 'm039_glint_identification',
...
json_path = RESULTS_DIR / "m039_glint_identification.json"
