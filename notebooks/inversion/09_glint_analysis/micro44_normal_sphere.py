...
Uses saved micro41 results for glint identification (hi-fi oracle labels).
"""
...
RESULTS_DIR = PROJECT_ROOT / "data" / "results" / "inversion_diagnostics" / "micro44_normal_sphere"
...
OMEGA_MAG_RANGE_DPS = (0.5, 5.0)   # same as micro41
...
# ===========================================================================
print("=" * 70)
print(f"micro44 -- Normal-family sphere (seed={SEED}, mode={MODE})")
print("=" * 70)
...
# --- Load glint identification from micro41 saved results ---
print(f"\nLoading micro41 results for seed={SEED}...")
json_path = PROJECT_ROOT / "data" / "results" / "inversion_diagnostics" / "unsorted" / "micro41_glint_classification.json"
with open(json_path) as f:
    micro41_data = json.load(f)

traj_data = None
for t in micro41_data['trajectories']:
    if t['seed'] == SEED:
        traj_data = t
        break

if traj_data is None:
    raise ValueError(f"Seed {SEED} not found in micro41 results")
